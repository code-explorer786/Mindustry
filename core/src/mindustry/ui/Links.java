...
public class Links{
    ...
    private static void createLinks(){
        ...
        new LinkEntry("changelog", "https://github.com/code-explorer786/Mindustry/releases", Icon.list, Pal.accent.cpy(), true),
        ...
        new LinkEntry("suggestions", "https://github.com/code-explorer786/Mindustry-Suggestions/issues/new/choose/", Icon.add, Color.valueOf("ebebeb"), true),
        ...
        new LinkEntry("github", "https://github.com/code-explorer786/Mindustry/", Icon.github, Color.valueOf("24292e"), true),
        new LinkEntry("dev-builds", "https://github.com/Anuken/MindustryBuilds", Icon.githubSquare, Color.valueOf("fafbfc")),
        new LinkEntry("dev-builds", "https://github.com/code-explorer786/MindustryBuilds", Icon.githubSquare, Color.valueOf("fafbfc"), true),
        new LinkEntry("bug", report(false), Icon.wrench, Color.valueOf("cbd97f")),
        new LinkEntry("bug", report(true), Icon.wrench, Color.valueOf("cbd97f"), true)
        };
    }
    ...
    public static class LinkEntry{
        ...
        public LinkEntry(String name, String link, Drawable icon, Color color, boolean fork){
            this.name = name;
            this.color = color;
    ...
    private static String report(boolean fork){
        return "https://github.com/"+(fork ? "code-explorer786" : "Anuken")+"/Mindustry/issues/new?assignees=&labels=bug&body=" +
        ...
        *Place an X (no spaces) between the brackets to confirm that you have read the line below.*
        - [ ] **I have updated to the latest release (https://github.com/mindustryauthor/Mindustry/releases) to make sure my issue has not been fixed.**
        - [ ] **I have searched the closed and open issues to make sure that this problem has not already been reported.**
        """.replace("mindustryauthor", fork ? "code-explorer786" : "Anuken"),
